...
%--------------------------------------------------------------------------
    ...
    text(min(I_0p25)+0.1,0.95*max(V_0p25),'$T_0=0.84T_c,\,\kappa=1$','FontSize',24,'Interpreter','LaTeX');
    text(min(I_0p25)+0.1,0.85*max(V_0p25),'$l_z=3\xi(0)$','FontSize',24,'Interpreter','LaTeX');
...
%     leg = legend([l_0p25,l_0p50,l_0p75,l_1p00,l_o],'$h_s=0.25$','$h_s=0.50$','$h_s=0.75$','$h_s=1.00$','Ohm','Location',pos);
    ...
    text(min(I_0p25)+0.1,0.85*fct*max(R_0p25),'$T_0=0.84T_c,\,\kappa=1$','FontSize',24,'Interpreter','LaTeX');
    text(min(I_0p25)+0.1,0.75*fct*max(R_0p25),'$l_z=3\xi(0)$','FontSize',24,'Interpreter','LaTeX');
    set(gca,'TickLabelInterpreter','LaTeX','FontSize',24);
...
%     close all;
    ...
    load T_0.84/kappa_1.0/Lz_6/hf_0.25_hs_0.25/IV.dat
    ...
    load T_0.84/kappa_1.0/Lz_6/hf_0.25_hs_0.50/IV.dat
    
    I_0p50 = IV(:,2);
    V_0p50 = IV(:,3);
    R_0p50 = diffxy(I_0p50,V_0p50);

    load T_0.84/kappa_1.0/Lz_6/hf_0.25_hs_0.75/IV.dat
    ...
    ylabel('$V/\varphi_{GL}$','Interpreter','LaTeX','FontSize',14);
    text(min(I_0p25)+0.1,0.95*max(V_0p25),'$T_0=0.84T_c,\,\kappa=1$','FontSize',24,'Interpreter','LaTeX');
    text(min(I_0p25)+0.1,0.85*max(V_0p25),'$l_z=6\xi(0)$','FontSize',24,'Interpreter','LaTeX');
    set(gca,'TickLabelInterpreter','LaTeX','FontSize',24);
    file_nt = strcat('IV','_nt.png');
    file_t = strcat('IV','_t.png');
    set(gca,'Color',[1 1 1]);
...
%     leg = legend([l_0p25,l_0p50,l_0p75,l_1p00,l_o],'$h_s=0.25$','$h_s=0.50$','$h_s=0.75$','$h_s=1.00$','Ohm','Location',pos);
    ...
    ylabel('$(dV/dI)/(\varphi_{GL}/I_{GL})$','Interpreter','LaTeX','FontSize',14);
    text(min(I_0p25)+0.1,0.85*fct*max(R_0p25),'$T_0=0.84T_c,\,\kappa=1$','FontSize',24,'Interpreter','LaTeX');
    text(min(I_0p25)+0.1,0.75*fct*max(R_0p25),'$l_z=6\xi(0)$','FontSize',24,'Interpreter','LaTeX');
    set(gca,'TickLabelInterpreter','LaTeX','FontSize',24);
    file_nt = strcat('IR','_nt.png');
    file_t = strcat('IR','_t.png');
    set(gca,'Color',[1 1 1]);
