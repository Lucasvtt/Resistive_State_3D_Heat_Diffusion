...
%--------------------------------------------------------------------------
    ...
    load T_0.84/kappa_1.0/Lz_3/hf_0.25_hs_1.00/Down_Sweep/IV.dat
    ...
    load T_0.84/kappa_1.0/Lz_3/ideal/Down_Sweep/IV.dat
    ...
    load T_0.84/kappa_1.0/Lz_3/No_Heat_Diffusion/Down_Sweep/IV.dat
    ...
    text(min(I_1p00)+0.1,0.6*max(V_nhd),'$T_0=0.84T_c,\,\kappa=1$','FontSize',24,'Interpreter','LaTeX');
    text(min(I_1p00)+0.1,0.5*max(V_nhd),'$l_z=3\xi(0)$','FontSize',24,'Interpreter','LaTeX');
...
%     close all;
    ...
    load T_0.84/kappa_1.0/Lz_6/hf_0.25_hs_1.00/Down_Sweep/IV.dat
    ...
    load T_0.84/kappa_1.0/Lz_6/ideal/Down_Sweep/IV.dat
    ...
    load T_0.84/kappa_1.0/Lz_6/No_Heat_Diffusion/Down_Sweep/IV.dat
    ...
    xlabel('$I/I_{GL}$','Interpreter','LaTeX','FontSize',14);
    ylabel('$V/\varphi_{GL}$','Interpreter','LaTeX','FontSize',14);
    text(min(I_1p00)+0.2,0.6*max(V_nhd),'$T_0=0.84T_c,\,\kappa=1$','FontSize',24,'Interpreter','LaTeX');
    text(min(I_1p00)+0.2,0.5*max(V_nhd),'$l_z=6\xi(0)$','FontSize',24,'Interpreter','LaTeX');
    set(gca,'TickLabelInterpreter','LaTeX','FontSize',24);
    file_nt = strcat('IV_histeresis','_nt.png');
    file_t = strcat('IV_histeresis','_t.png');
    set(gca,'Color',[1 1 1]);
