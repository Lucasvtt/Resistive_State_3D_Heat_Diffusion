...
%--------------------------------------------------------------------------
    ...
    load T_0.84/kappa_1.0/Lz_3/hf_0.25_hs_0.25/period.dat
    ...
    load T_0.84/kappa_1.0/Lz_3/hf_0.25_hs_0.50/period.dat
    ...
    load T_0.84/kappa_1.0/Lz_3/hf_0.25_hs_0.75/period.dat
    ...
    pos = 'best';
    leg = legend([l_0p25,l_0p50,l_0p75,l_1p00],'$h_s=0.25$','$h_s=0.50$','$h_s=0.84$','$h_s=1.00$','Location',pos);
    legend('boxoff');
    ...
    text(min(I_0p25)+0.05,0.9*max(F_1p00),'$T_0=0.84T_c,\,\kappa=1$','FontSize',24,'Interpreter','LaTeX');
    text(min(I_0p25)+0.05,0.83*max(F_1p00),'$l_z=3\xi(0)$','FontSize',24,'Interpreter','LaTeX');
...
%     close all;
    ...
    load T_0.84/kappa_1.0/Lz_6/hf_0.25_hs_0.25/period.dat
    ...
    load T_0.84/kappa_1.0/Lz_6/hf_0.25_hs_0.50/period.dat
    ...
    load T_0.84/kappa_1.0/Lz_6/hf_0.25_hs_0.75/period.dat
    ...
    load T_0.84/kappa_1.0/Lz_6/hf_0.25_hs_1.00/period.dat
    ...
    xlabel('$I/I_{GL}$','Interpreter','LaTeX','FontSize',14);
    ylabel('$\nu t_{GL}$','Interpreter','LaTeX','FontSize',14);
    text(min(I_0p25)+0.035,0.975*max(F_1p00),'$T_0=0.84T_c,\,\kappa=1$','FontSize',24,'Interpreter','LaTeX');
    text(min(I_0p25)+0.035,0.94*max(F_1p00),'$l_z=6\xi(0)$','FontSize',24,'Interpreter','LaTeX');
    set(gca,'TickLabelInterpreter','LaTeX','FontSize',24);
    file_nt = strcat('frq','_nt.png');
    file_t = strcat('frq','_t.png');
    set(gca,'Color',[1 1 1]);
