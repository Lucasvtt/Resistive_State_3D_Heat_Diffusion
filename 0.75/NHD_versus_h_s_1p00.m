...
%     R_o = l_x/(A*sigma)*I_nhd./I_nhd;    
    ...
    ylim([min([min(V_1p00) min(V_id) min(V_nhd)]) max([max(V_1p00) max(V_id) max(V_o)])]);
    pos = 'northwest';
    ...
    text(min(I_1p00)+0.2,0.55*max(V_nhd),'$T_0=0.75T_c,\,\kappa=1$','FontSize',24,'Interpreter','LaTeX');
    text(min(I_1p00)+0.2,0.45*max(V_nhd),'$l_z=2.4\xi(0)$','FontSize',24,'Interpreter','LaTeX');
    ...
    ylim([0 fct*max([max(R_1p00) max(R_id) max(R_nhd)])]);
    pos = 'northwest';
    ...
    text(min(I_1p00)+0.1,0.55*fct*max(R_nhd),'$T_0=0.75T_c,\,\kappa=1$','FontSize',24,'Interpreter','LaTeX');
    text(min(I_1p00)+0.1,0.45*fct*max(R_nhd),'$l_z=2.4\xi(0)$','FontSize',24,'Interpreter','LaTeX');
    text(min(I_1p00)+0.22,0.25*fct*max(R_nhd),'Meissner State','FontSize',24,'Interpreter','LaTeX');
    text(min(I_1p00)+1.73,0.25*fct*max(R_nhd),'Resistive State','FontSize',24,'Interpreter','LaTeX');
    set(gca,'TickLabelInterpreter','LaTeX','FontSize',24);
...
%     R_o = l_x/(A*sigma)*I_nhd./I_nhd;    
    ...
    ylabel('$V/\varphi_{GL}$','Interpreter','LaTeX','FontSize',14);
    text(min(I_1p00)+0.2,0.55*max(V_nhd),'$T_0=0.75T_c,\,\kappa=1$','FontSize',24,'Interpreter','LaTeX');
    text(min(I_1p00)+0.2,0.45*max(V_nhd),'$l_z=4.8\xi(0)$','FontSize',24,'Interpreter','LaTeX');
    set(gca,'TickLabelInterpreter','LaTeX','FontSize',24);
    file_nt = strcat('IV_nhd','_nt.png');
    file_t = strcat('IV_nhd','_t.png');
    set(gca,'Color',[1 1 1]);
    ...
    xlabel('$I/I_{GL}$','Interpreter','LaTeX','FontSize',14);
    ylabel('$(dV/dI)/(\varphi_{GL}/I_{GL})$','Interpreter','LaTeX','FontSize',14);
    text(min(I_1p00)+0.2,0.9*fct*max(R_nhd),'$T_0=0.75T_c,\,\kappa=1$','FontSize',24,'Interpreter','LaTeX');
    text(min(I_1p00)+0.2,0.75*fct*max(R_nhd),'$l_z=4.8\xi(0)$','FontSize',24,'Interpreter','LaTeX');
    set(gca,'TickLabelInterpreter','LaTeX','FontSize',24);
    file_nt = strcat('IR_nhd','_nt.png');
    file_t = strcat('IR_nhd','_t.png');
    set(gca,'Color',[1 1 1]);
