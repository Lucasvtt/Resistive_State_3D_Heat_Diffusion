...
%--------------------------------------------------------------------------
    ...
    load T_0.75/kappa_1.0/Lz_2.4/hf_0.25_hs_0.15/IV.dat
    ...
    load T_0.75/kappa_1.0/Lz_2.4/hf_0.25_hs_0.30/IV.dat
    ...
    text(0.5,1.565,'$T_0=0.75T_c,\,\kappa=1$','FontSize',24,'Interpreter','LaTeX');
    text(0.5,1.545,'$l_z=2.4\xi(0)$','FontSize',24,'Interpreter','LaTeX');
