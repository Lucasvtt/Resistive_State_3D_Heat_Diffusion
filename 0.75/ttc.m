...
%--------------------------------------------------------------------------
    ...
    load T_0.75/kappa_1.0/Lz_2.4/hf_0.25_hs_0.25/Qm.dat
    ...
    load T_0.75/kappa_1.0/Lz_2.4/hf_0.25_hs_0.50/Qm.dat
    
    I_0p50 = A*Qm(:,1);
    Q_0p50 = h_s(2)*Qm(:,2);

    load T_0.75/kappa_1.0/Lz_2.4/hf_0.25_hs_0.75/Qm.dat
    
    I_0p75 = A*Qm(:,1);
    Q_0p75 = h_s(3)*Qm(:,2);    

    load T_0.75/kappa_1.0/Lz_2.4/hf_0.25_hs_1.00/Qm.dat
    ...
    text(min(I_0p25)+0.1,0.9*max(Q_1p00),'$T_0=0.75T_c,\,\kappa=1$','FontSize',24,'Interpreter','LaTeX');
    text(min(I_0p25)+0.1,0.8*max(Q_1p00),'$l_z=2.4\xi(0)$','FontSize',24,'Interpreter','LaTeX');
...
%     close all;
    ...
    load T_0.75/kappa_1.0/Lz_4.8/hf_0.25_hs_0.25/Qm.dat
    ...
    load T_0.75/kappa_1.0/Lz_4.8/hf_0.25_hs_0.50/Qm.dat
    
    I_0p50 = A*Qm(:,1);
    Q_0p50 = h_s(2)*Qm(:,2);

    load T_0.75/kappa_1.0/Lz_4.8/hf_0.25_hs_0.75/Qm.dat
    
    I_0p75 = A*Qm(:,1);
    Q_0p75 = h_s(3)*Qm(:,2);    

    load T_0.75/kappa_1.0/Lz_4.8/hf_0.25_hs_1.00/Qm.dat
    ...
    xlabel('$I/I_{GL}$','Interpreter','LaTeX','FontSize',14);
    ylabel('$\dot{Q}/\dot{Q}_{GL}$','Interpreter','LaTeX','FontSize',14);
    text(min(I_0p25)+0.15,0.9*max(Q_1p00),'$T_0=0.75T_c,\,\kappa=1$','FontSize',24,'Interpreter','LaTeX');
    text(min(I_0p25)+0.15,0.8*max(Q_1p00),'$l_z=4.8\xi(0)$','FontSize',24,'Interpreter','LaTeX');
    set(gca,'TickLabelInterpreter','LaTeX','FontSize',24);
    file_nt = strcat('Q','_nt.png');
    file_t = strcat('Q','_t.png');
    set(gca,'Color',[1 1 1]);
